...
<?php head("spkg - downloads page"); ?>
 ...
 <h1>Binary packages</h1>
  ...
  <p>You can download latest binary package of
  <a href="dl/spkg-@VER@-i486-1.tgz">spkg</a>
<!--  and <a href="dl/pyspkg-@VER@-i486-1.tgz">pyspkg</a> -->
  for slackware-current <a href="dl/">here</a>.</p>
